...
if __name__ == '__main__':
    with ABC_model:
        ...
        U11 = c12*c13
        U12 = s12*c13
        U13 = s13*t.sqrt( (cDEL)**2 + (sDEL)**2 )
        
        U21 = t.sqrt( (s12*c23 + c12*s23*s13*cDEL)**2 + (c12*s23*s13*sDEL)**2 )
        U22 = t.sqrt( (c12*c23 - s12*s23*s13*cDEL)**2 + (s12*s23*s13*sDEL)**2 )
        U23 = s23*c13
        
        U31 = t.sqrt( (s12*s23 - c12*c23*s13*cDEL)**2 + (c12*c23*s13*sDEL)**2 )
        U32 = t.sqrt( (c12*s23 + s12*c23*s13*cDEL)**2 + (s12*c23*s13*sDEL)**2 )
        U33 = c23*c13
        
        
        P_mue_REAL = (c13**2)*(-(s13**2)*(s23**2)*(c12**2) -(c23*c12*s23*s13*s12  * cDEL) \
                               -(s12**2)*(s13**2)*(s23**2) +((s12**2)*c23*s23*s13 * cDEL))
      
        P_mue_IMAG = (c13**2)*((c23*c12*s23*s13*s12*sDEL)-(s12**2)*(c23*s23*s13*sDEL))
        #muon to electron
    ...
    np.savetxt("C:/Users/k20087271/Documents/Reparametrisation data/theta12", data_theta12, delimiter = ', ')
    np.savetxt("C:/Users/k20087271/Documents/Reparametrisation data/theta13", data_theta13, delimiter = ', ')
    np.savetxt("C:/Users/k20087271/Documents/Reparametrisation data/theta23", data_theta23, delimiter = ', ')
    np.savetxt("C:/Users/k20087271/Documents/Reparametrisation data/delta  ", data_delta  , delimiter = ', ')

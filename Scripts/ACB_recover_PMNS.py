...
if __name__ == '__main__':
    with ACB_model:
        ...
        U11 = c12*c13
        U12 = s12
        U13 = c12*s13*t.sqrt( (cDEL)**2 + (sDEL)**2 )
        
        U21 = t.sqrt( (s12*c23*c13 + s23*s13*cDEL)**2 + (s23*s13*sDEL)**2 )
        U22 = c23*c12
        U23 = t.sqrt( (s23*c13 - c23*s12*s13*cDEL)**2 + (c23*s12*s13*sDEL)**2 )
        
        U31 = t.sqrt( (s12*s23*c13 - c23*s13*cDEL)**2 + (c23*s13*sDEL)**2 )
        U32 = s23*c12
        U33 = t.sqrt( (c13*c23 + s12*c13*s23*cDEL)**2 + (s12*c13*s23*sDEL)**2 )
        
        
        P_mue_REAL = -c12**2*c13**4*c23*s23*s12*cDEL -s23**2*c12**2*c13**3*s13 \
        +s12**2*c12**2*c13**3*c23**2*s13 + s13**2*c12**2*c13**2*c23*s23*s12*cDEL \
        +c12**2*c13**2*c23*s23*s12*cDEL -s12**2*c12**2*c23**2*c13*s13
      
        P_mue_IMAG = c12**2*c13**4*c23*s23*s12*sDEL +s13**2*c12**2*c13**2*c23*s23*s12*sDEL \
        -c12**2*c13**2*c23*s23*s12*sDEL
        #muon to electron
    ...
    np.savetxt("C:/Users/k20087271/Documents/Reparametrisation data/theta12_ACB", data_theta12, delimiter = ', ')
    np.savetxt("C:/Users/k20087271/Documents/Reparametrisation data/theta13_ACB", data_theta13, delimiter = ', ')
    np.savetxt("C:/Users/k20087271/Documents/Reparametrisation data/theta23_ACB", data_theta23, delimiter = ', ')
    np.savetxt("C:/Users/k20087271/Documents/Reparametrisation data/delta_ACB  ", data_delta  , delimiter = ', ')